...
!function ($) {
    ...
    Password.prototype.init = function() {
        ...
        this.$icon = $([
            ...
            '<i class="glyphicon-eye-open' + (this.options.white ? ' icon-white' : '') +
    ...
    Password.prototype.show = function(_relatedTarget) {
        ...
        this.$text.show();
        this.$icon.find('i')
            .removeClass('glyphicon-eye-open ' + this.options.eyeOpenClass)
            .addClass('glyphicon-eye-close ' + this.options.eyeCloseClass);
    ...
    Password.prototype.hide = function(_relatedTarget) {
        ...
        this.$text.hide();
        this.$icon.find('i')
            .removeClass('glyphicon-eye-close ' + this.options.eyeCloseClass)
            .addClass('glyphicon-eye-open ' + this.options.eyeOpenClass);
