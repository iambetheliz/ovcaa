...
<div class="wrap">
    <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><strong>Documents <font color="#7b1113">(<?php echo $count; ?>)</font></strong></h1>
                    </div>
                </div>
                <!-- End of Page Heading -->
                    ...
                    <div class="col col-xs-2 text-right">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="index.php?sorting='.$sort.'&field=title">Title</a></li>
                                <li><a href="index.php?sorting='.$sort.'&field=cat_name">Category</a></li>
                                <li><a href="index.php?sorting='.$sort.'&field=uploaded_by">Uploader</a></li>
                                <li><a href="index.php?sorting='.$sort.'&field=date_updated">Latest</a></li>
                            </ul>
                        </div>
                    </div>
